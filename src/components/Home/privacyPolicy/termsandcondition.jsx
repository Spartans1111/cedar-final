...
export default function Termsandcondition() {
  return (
    <div className='privacy'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cedar Interiors , Cedar Interiors,
            Robinson Road, Emmar Plaza, Palakkad, 678001.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cedar Interiors, accessible from{" "}
            <a
              href="www.cedarinteriors.in"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.cedarinteriors.in
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: contact@cedarinteriors.in</li>
      </ul>
    </div>
  );
}
